...
var Dropdown = class _Dropdown extends BaseComponent {
  ...
  static jQueryInterface(config) {
    return this.each(function() {
      _Dropdown.dropdownInterface(this, config);
    });
  }
...
var Modal = class _Modal extends BaseComponent {
  ...
  static jQueryInterface(config, relatedTarget) {
    return this.each(function() {
      const data = _Modal.getInstance(this) || new _Modal(this, typeof config === "object" ? config : {});
      if (typeof config !== "string") {
        return;
      }
      if (typeof data[config] === "undefined") {
...
var Offcanvas = class _Offcanvas extends BaseComponent {
  ...
  static jQueryInterface(config) {
    return this.each(function() {
      const data = Data.get(this, DATA_KEY$5) || new _Offcanvas(this, typeof config === "object" ? config : {});
      if (typeof config !== "string") {
        return;
      }
...
var ScrollSpy = class _ScrollSpy extends BaseComponent {
  ...
  _getConfig(config) {
    ...
    if (typeof config.target !== "string" && isElement2(config.target)) {
      let {
        id
      } = config.target;
      if (!id) {
  ...
  static jQueryInterface(config) {
    return this.each(function() {
      const data = _ScrollSpy.getInstance(this) || new _ScrollSpy(this, typeof config === "object" ? config : {});
      if (typeof config !== "string") {
        return;
      }
      if (typeof data[config] === "undefined") {
